...
const Slide = ({ item }: SlideProps) => {
  ...
  return (
    <div
      className="relative min-h-96 flex flex-col justify-center
                 px-12 pb-14 pt-11 overflow-hidden
                 bg-[#0f0500]"
    >
      {/* Grid overlay */}
      <div
        className="absolute inset-0 pointer-events-none
                   [background-image:linear-gradient(rgba(255,100,0,0.07)_1px,transparent_1px),linear-gradient(90deg,rgba(255,100,0,0.07)_1px,transparent_1px)]
